...
addListener(
    ...
    function() {
        ...
        // Attach controllers.
        try{require('x-widget')('theatre100189','theatre100',"")}catch(x){console.error('Unable to initialize theatre100!', x)}
try{require('x-widget')('theatre100.main190','theatre100.main',{size: 2})}catch(x){console.error('Unable to initialize theatre100.main!', x)}
try{require('x-widget')('theatre100.main191','theatre100.main',{size: 3})}catch(x){console.error('Unable to initialize theatre100.main!', x)}
try{require('x-widget')('theatre100.main192','theatre100.main',{size: 4})}catch(x){console.error('Unable to initialize theatre100.main!', x)}
try{require('x-widget')('theatre100.main193','theatre100.main',{size: 5})}catch(x){console.error('Unable to initialize theatre100.main!', x)}
try{require('x-widget')('theatre100.main194','theatre100.main',{size: 6})}catch(x){console.error('Unable to initialize theatre100.main!', x)}
try{require('x-widget')('theatre100.main195','theatre100.main',{size: 7})}catch(x){console.error('Unable to initialize theatre100.main!', x)}
    }
);
